        ...
        <div className={styles.aboutWrapper}>
          <article className={styles.textAbt}>
            ...
            <p>
              ...
              sitting in front of an Illustrator artboard tweaking pixels. You
              can always find me buried in stylesheets, fiddling with font sizes
              and thinking about layouts (~_^). Creating fluid user experiences
              is something I&apos;m committed to doing while looking chic.
            </p>
          </article>
